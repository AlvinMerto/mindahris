...
<script type="text/javascript">
    ...
    var BASE_URL = '<?php echo base_url(); ?>';
        ...
        $('#jqx_add_shift').on('click',function(){
        		...
        		showmessage('You are about to add new shift, make sure follow format below..' , 'warning');
        		$('#add_shift_form').show();
        		$('#btn_shift_form').show();
        ...
        $('#btn_shift_update').on('click',function(){
        	...
        	if($('#text_box_shift_name').val() == ''){
        		showmessage('Shift name required.' , 'danger');
        		return false;
        	}
	        ...
	        for (var i = 0; i < rows.length; i++) {
	      	...
	      	if(update){
	      		...
	      		if(update == '-1'){
	      				...
	      				showmessage('You cannot update this shift , because there is already assigned users..' , 'danger');
