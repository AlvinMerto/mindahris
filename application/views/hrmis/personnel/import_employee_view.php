   ...
   <div class="row">
       ...
       <div class="col-lg-12">
    	<div class="form-group">
	    			...
	    			<a href="<?php echo base_url(); ?>personnel/employee" class="btn btn-sm btn-primary"> <i class="fa fa-backward"></i> Back</a>
     ...
     <div class="col-md-9">
       <div class="box">
           <div class="box-header with-border">
              <h3 class="box-title">Import Employee CSV File</h3>
