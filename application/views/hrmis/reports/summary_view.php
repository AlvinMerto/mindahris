                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active in" id="joangency">
                                    ...
                                    <div style="padding:20px;">
                                      ...
                                      <div class="row">
                                        <div class="col-md-12">
                                           <h5>SUMMARY OF DAILY TIME RECORDS OF JOB ORDERS AS OF <?php  date_default_timezone_set("Asia/Manila"); echo date('F d, Y , l h:i:s a');?></h5>
                                ...
                                <div class="tab-pane fade" id="plantilla">
                                    ...
                                    <div style="padding:20px;">
                                           ...
                                           <div class="row" style="margin-bottom:0px;">
                                              ...
                                              <div class="col-md-1">
                                                  <button class="btn btn-sm btn-primary" id="btn_date_covered_add_regular" >Add new </button>
                                              </div>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                           <h5>REPORTS ON THE SUBMISSION OF DAILY TIME RECORDS FOR PLANTILLA AS OF <?php date_default_timezone_set("Asia/Manila");  echo date('F d, Y , l h:i:s a');?></h5>
          ...
          $("#jqxdaterange").on('change', function (event) {
                     ...
                     if(update){
                       ...
                       $('#btn_edit_date_covered_jo').show();
                        ...
                        LIST_COVER_DATES_JO =  loadcoverdates('JO');
                         ...
                         showmessage('Date cover updated' , 'success');
            ...
            $("#allow_jo_submit").change(function() {
                 ...
                 if(update){
                         LIST_COVER_DATES_JO =  loadcoverdates('JO');
                         if($(this).is(":checked")) {   
                            showmessage('Allow to submit set to active' ,'success');
                         }else{
                            showmessage('Allow to submit set to inactive' ,'success');
                         } 
