        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">My Applications / Details </h3>
                </div>
    ...
    <div id="jqxLoader"></div>
      ...
      <div id="jqxPopover" style="display:none;">
            <center>
                <div class="alert alert-info" id="warning_msg" >
                    <div class="row">
                ...
                <button id="btn_continue_" class="btn btn-xs btn-success">Approved & Sign</button>
                ...
                <div class="col-md-12" style="margin-bottom: 10px;">
                        <a href="<?php echo base_url(); ?>reports/applications"class="btn btn-sm btn-default">BACK</a>
                        <a id="btn_print_form_preview" href="#"class="btn btn-sm btn-primary">PRINT PREVIEW</a>
                        <a id="btn_cancel_application" href="#"class="btn btn-sm btn-danger">CANCEL THIS APPLICATION</a>
                </div>
                        ...
                        <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12"> 
                                                ...
                                                <div  id="container_ps" style="border:solid 1px #ddd; width: 1000px; display:none; padding:20px;">
                                                 ...
                                                 <div id="container_paf" style="border:solid 1px #ddd; width: 1000px;display:none; padding:20px;">
                                                ...
                                                <div id="container_leave" style="border:solid 1px #ddd; width: 1000px;display:none; padding:20px; margin-left:20px;">
                                                ...
                                                <div id="container_ot" style="border:solid 1px #ddd; width: 100%; display:none; padding:20px;">
