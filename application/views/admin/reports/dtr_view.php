...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Daily Time Records</h3>
        </div>
        <!-- /.col-lg-12 -->
        </pre>
                 ...
                 <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group" id="view_admin_form" style="display:block;">
                          ...
                          <div class="row">
                             ...
                             <div class="col-md-2 col-sm-12">
                              <div style="margin-top:19px;">
                                <input style="display:none;" type="button" class="btn btn-sm btn-success" value="PRINT PREVIEW" id="jqx_print_admin"/>
                                </div>
                             </div>
                            </div>
                         ...
                         <div style="border-top: 1px solid rgb(204, 204, 204); margin-top: 28px;margin-bottom: 30px;"></div>


                            <div class="row" style="background-color: rgb(217, 237, 247); padding-top: 18px;margin-left: 1px;margin-right: 34px;">

                              <div class="col-md-3">
                               <p style="color: rgb(96, 102, 107);">TIME SHIFT / SCHEDULE: <strong><span id="total_time_shift_sched"></span></strong></p>
                               ...
                               <p id="total_temporary_shift" style="font-size:11px; color: rgb(96, 102, 107);"></p>
                                ...
                                <p style="color: rgb(96, 102, 107); font-weight: bold; font-size: 11px;"><strong> | <span>H = Holiday </span> | <span >A = ABSENT </span> |  <span >N/A = NOT ABSENT </span> | <span> IC = INCOMPLETE </span> |  </strong></p>

                              </div>

                              <div class="col-md-3">
                                <p style="color: rgb(96, 102, 107);">NO. OF WORKING DAYS: <strong><span id="total_working_days"></span></strong></p>
                                <p style="color: rgb(96, 102, 107);">SERVICES RENDERED: <strong><span id="total_services_r"></span></strong></p>
                                <p style="color: rgb(96, 102, 107);">TARDINESS & UNDERTIME: <strong><span id="total_tardiness_undertime"></span></strong></p>

                              </div>

                              <div class="col-md-3">
                                <p style="color: rgb(96, 102, 107);">NO. OF HOLIDAYS: <strong><span id="total_holidays"></span></strong></p>
                                <p style="color: rgb(96, 102, 107);">SERVICES RENDERED: <strong><span id="total_holiday_services_r"></span></strong></p>
                                <p style="color: rgb(96, 102, 107);">TARDINESS & UNDERTIME: <strong><span id="total_holiday_tardiness_undertime"></span></strong></p>
                              </div>

                              <div class="col-md-3">
                                <p style="color: rgb(96, 102, 107);">TOTAL LATES:  <strong><span id="total_lates_input_display"></span></strong></p>
                                <p style="color: rgb(96, 102, 107);">TOTAL UNDERTIME:  <strong><span id="total_undertime_input_display"></span></strong></p>
                                <p style="color: rgb(96, 102, 107);">TOTAL PS:  <strong><span id="total_ps_input_display"></span></strong></p>
                                <p style="color: rgb(96, 102, 107);">TOTAL ABSENCES:  <strong><span id="total_absences_input_display"></span></strong></p>
                                <p style="color: rgb(96, 102, 107);">TOTAL:  <strong><span id="total_input_display"></span></strong></p>
      ...
      // Create a jqxComboBox
                      ...
                      if(value == dtr_cover_list[i].dtr_cover_id){
                            ...
                            if(is_submitted != 0){
                              ...
                              if(is_allow_to_submit == 0){  
                                 $('#date_covered_note_label').html('Note: HR is not already allowed to submit DTR. Please check again later.. ');
                                 $('#date_covered_note_label').css('color' , 'red');  
                                 $('#btn_proceed_hr_submission').hide();     
                              }
         ...
         $('#btn_proceed_hr_submission').on('click',function(){
                ...
                var info = {};
                  ...
                  info['leaves_on'] = '';  
                    ...
                    if(flag == 0){
                      alert('Incomplete requirements. You cannot submit it to the HR.');
                    }else{
        ...
        function saveot(){
            ...
            if(rows.length == 1){ 
              ...
              console.log('isa lng ka adlaw pde mka file og overtime');
               ...
               success: function (data) {
                   ...
                   for (i in users){
                    ...
                    if (type_mode == 'PS' || type_mode == 'PAF' || type_mode == 'LEAVE'){  
                        ...
                        //var exact_id = data.replace(/'/g, '');           
                        window.open(BASE_URL + 'reports/applications/'+ parseInt(data) +'/'+type_mode); 
                    }
...
alert("processing dtr in old script")
        ...
        var index_1 = '';
          ...
          for (i in dtr_array){
            ...
            if(dtr_array[i].EXCEPTION != '0' && dtr_array[i].EXCEPTION != ''){
               row["CHECKDATE"] = dtr_array[i].CHECKDATE + ' <span style="font-size:11px; color:'+color+'"> (' +dtr_array[i].EXCEPTION+ ') </span>' ;
            }else{
               row["CHECKDATE"] = dtr_array[i].CHECKDATE;
            }
            ...
            if(checkdate_1 == today){
                 index_1 = index;
                 row["CHECKDATE"] = '<span style="font-weight:bold; color: blue ; padding:1px;  border-radius:2px 2px;">' + row["CHECKDATE"] + '</span>';
            }
            ...
            for (s in srow){
                  ...
                  var time_type_mode = '';
                    ...
                    if(types_md == "0"){
                      ...
                      if(types_md == "LEAVE" || types_md == "PS" || types_md == "PAF" || types_md == "CTO"){
                         time = '';
                      }
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                width:'100%',
                columns: [
                  { text: user_name, datafield: 'CHECKDATE'  ,width: 200},
