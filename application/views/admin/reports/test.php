...
<html lang="en">
<head>
    <title id='Description'>The following example shows how to get the TreeGrid's HTML, add it to a new browser window and trigger printing.</title>
    ...
    <script type="text/javascript" src="https://www.jqwidgets.com/jquery-widgets-demo/jqwidgets/jqxtreegrid.js"></script> 
