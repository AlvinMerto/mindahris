									...
									<div class="row">
										<div class="col-md-5">
										    ...
										    <div class="form-group">
										      ...
										      <div class="col-md-6">
										          <input type="hidden" class="form-control" id="textbox_employee_id" placeholder="eq. 03212016-241">
										          <input type="text" class="form-control" id="textbox_id_no" placeholder="eq.03212016-241">
										      </div>
										    </div>
										    ...
										    <div class="form-group">
										      ...
										      <div class="col-md-6">
										          <input type="text" class="form-control" id="text_box_device_id" placeholder="eq. 241 ">
										      </div>
										    </div>
										...
										<div class="col-md-3">
											...
											<div class="form-group" style="text-align: center; margin-top:20px;">
					                            ...
					                            <span class="color_orange" style="padding-right:10px;">(Optimal Size 120×140 Pixel)</span>
																		    ...
																		    <button class="btn btn-xs btn-default" type="button" id="btn_upload_image">Upload</button>													 
											...
											<div class="form-group" style="text-align: center; border-top: solid 1px #ddd;  margin-top:10px; padding-top: 10px; width: 200px; margin: auto">
											    ...
											    <button class="btn btn-xs btn-default" type="button" id="btn_upload_e_signature">Upload E-Signature</button>													 
