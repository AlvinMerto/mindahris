        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Leave Ledger </h3>
                </div>
            </div>
           	...
           	<div <?php  if($usertype == 'admin'){  echo 'style=""'; }else if ($usertype == 'user'){  echo 'style="display:none;"'; }else if ($usertype == 'f-admin'){   echo 'style="display:none;"';} ?>>
	            ...
	            <div class="row" style="margin-bottom: 20px;">
		 			<div class="col-md-12">
							...
							<button id="btn_upload_ledger" class="btn btn-warning	 btn-sm">UPLOAD EXCEL LEDGER</button>
	            	</div>       
		        </div>
					...
					<div class="col-lg-6">
	                    ...
	                    <div class="panel panel-info">
	                        <div class="panel-heading">
	                           	LEAVE CREDITS BALANCE <span id="as_of_date" style="font-style: italic; font-size: 12px; margin-left:20px; color:green;"> </span>
	                        </div>
	                        <!-- /.panel-heading -->
	                        <div class="panel-body">
	                            <div class="table-responsive">
	                                <table class="table" id="tbl_leave_ledger">
	                                    <thead>
	                                        <tr>
	        ...
	        <!--  LEAVE LEDGER -->
	       	...
	       	<div id="leave_ledger_box" class="row" style="margin-top:20px;" style="display:none;">
	       		<div class="col-md-12">
	       			<div class="panel panel-info">
		       			<div class="panel-heading">
		       				Leave ledger
		                 ...
		                 var fullname = item.label;
							        ...
							        for (i in users){
					                	...
					                	if(credits_as_of == null){
					                	    ...
					                	    var display_as_of_date = new Date(credits_as_of);
					                		credits_as_of = ' as of ' + display_as_of_date;
					                	}
