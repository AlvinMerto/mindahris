        <div id="page-wrapper">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h3 class="page-header">Guard Monitoring  PS / AMS </h3>
                </div>
                ...
                <div class="panel panel-info">
                        <div class="panel-heading">
                            Monitoring AMS (for failed to login on biometrics) / PS time out/in
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <!--  PS TAB -->
                                <div class="tab-pane fade active in" id="ps">
                                    ...
                                    <div style="padding:20px;"> 
                                        <button id="btn_refresh_ps" style="float:right;margin-bottom:10px;" class="btn btn-sm btn-success">REFRESH</button>
...
<script type="text/javascript">
    ...
    var SES_GUARD_AREA_ID = '<?php echo $guard_area_id; ?>';
        ...
        function getplantillatree(){
              ...
              var serverDate = '<?= date("m/d/Y", time()) ?>';
            ...
            var dataAdapter_1 = new $.jqx.dataAdapter(source);
              ...
              $("#jqx_ams_plantilla").jqxTreeGrid(
              {
                  ...
                  columns: [
                    ...
                    { text: "IN", columnGroup: "AM", cellsAlign: "center", align: "center", dataField: "a_in", width: 100 ,editable: false ,  cellsFormat: 'hh:mm tt' ,formatString: 'hh:mm tt'},    
                    { text: 'OUT', columnGroup: "AM", dataField: "a_out", cellsAlign: "center", align: "center", width: 100 ,editable: false ,  cellsFormat: 'hh:mm tt' ,formatString: 'hh:mm tt'},
                    { text: "IN", columnGroup: "PM", dataField: "p_in" , cellsAlign: "center", align: "center", width: 100 ,editable: false,  cellsFormat: 'hh:mm tt' ,formatString: 'hh:mm tt'},
                    { text: "OUT", columnGroup: "PM", dataField: "p_out" , cellsAlign: "center", align: "center", width: 100 ,editable: false,  cellsFormat: 'hh:mm tt' ,formatString: 'hh:mm tt'},
                    { text: "IN", columnGroup: "OT", dataField: "o_in" , cellsAlign: "center", align: "center", width: 100 ,editable: false,  cellsFormat: 'hh:mm tt' ,formatString: 'hh:mm tt'},
                    { text: "OUT", columnGroup: "OT", dataField: "o_out" , cellsAlign: "center", align: "center", width: 100 ,editable: false,  cellsFormat: 'hh:mm tt' ,formatString: 'hh:mm tt'},
        ...
        function getemployeeams(){
                ...
                $("#jqxemployeelist").jqxGrid(
                {
                    ...
                    columns: [
                        ...
                        { text: 'IN', datafield: 'a_in', minwidth: 110 , align: 'center' , cellsalign: 'center'  ,columntype: 'datetimeinput' , cellsformat: 'hh:mm tt' ,formatString: 'hh:mm tt',
                        ...
                        { text: 'OUT', datafield: 'a_out', minwidth: 110 ,align: 'center' , cellsalign: 'center' , columntype: 'datetimeinput' , cellsformat: 'hh:mm tt',
                            createeditor: function (row, cellvalue, editor) {
                              editor.jqxDateTimeInput({ width: 'auto', height: '25px', formatString: 'hh:mm tt', showTimeButton: true, showCalendarButton: false});
                          }
                     },
                        { text: 'IN', datafield: 'p_in', minwidth: 110 , align: 'center' , cellsalign: 'center' , columntype: 'datetimeinput' , cellsformat: 'hh:mm tt' ,
                            createeditor: function (row, cellvalue, editor) {
                              editor.jqxDateTimeInput({ width: 'auto', height: '25px', formatString: 'hh:mm tt', showTimeButton: true, showCalendarButton: false});
                          }
                    },
                        { text: 'OUT', datafield: 'p_out', minwidth: 110 , align: 'center' , cellsalign: 'center' ,  columntype: 'datetimeinput' , cellsformat: 'hh:mm tt',
                            createeditor: function (row, cellvalue, editor) {
                              editor.jqxDateTimeInput({ width: 'auto', height: '25px', formatString: 'hh:mm tt', showTimeButton: true, showCalendarButton: false});
                          }                         
                    },
                        ...
                        var data = $('#jqxemployeelist').jqxGrid('getrowdata', cell.rowindex );
                            ...
                            if(cell.datafield == 'a_in' || cell.datafield == 'a_out' || cell.datafield == 'p_in' || cell.datafield == 'p_out' || cell.datafield == 'remarks'){
                                ...
                                if(updateamstime){
                                    ...
                                    showmessage('Somethings wrong.Please try again.', 'danger');
                                }     
